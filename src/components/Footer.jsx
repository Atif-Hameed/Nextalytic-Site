...
import Icon1 from '../asset/footerIcon1.svg'
import Icon2 from '../asset/footerIcon2.svg'
import Icon3 from '../asset/footerIcon3.svg'
import Icon4 from '../asset/footerIcon4.svg'
                    ...
                    <div className='grid lg:grid-cols-3 grid-cols-1 lg:gap-y-0 gap-y-16 lg:w-[70%] sm:w-[60%] w-full'>
                        ...
                        <div className='text-white font-manrope flex flex-col gap-4'>
                            ...
                            <div className='flex gap-2 items-center'>
                                <img src={Icon1} className='h-3' alt="" />
                            ...
                            <div className='flex gap-2 items-center'>
                                <img src={Icon3} className='h-3' alt="" />
                                <p className='font-light text-sm font-manrope'>Instagram</p>
                            </div>
                            <div className='flex gap-2 items-center'>
                                <img src={Icon4} className='h-3' alt="" />
