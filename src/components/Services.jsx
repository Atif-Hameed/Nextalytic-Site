            ...
            <div className='bg-white sm:py-28 py-14'>
                <div className='xl:px-24 lg:px-16 sm:px-8 px-4'>
                    ...
                    <div className='flex justify-between items-center mt-2 sm:flex-nowrap flex-wrap'>
                        <div className='flex flex-col gap-1 xl:w-[50%] lg:w-[65%] sm:w-[60%] w-full'>
                        ...
                        <div className='xl:w-[50%] lg:w-[35%] sm:w-[40%] w-full  flex justify-end'>
                            <button className='text-white hover:scale-105 transition-all duration-200 bg-[#091438] sm:text-sm text-xs sm:px-5 px-3 py-3 rounded-3xl'>Explore All Services</button>
                        </div>
                    </div>
                </div>
